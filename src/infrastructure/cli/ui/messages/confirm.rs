use crate::{
    infrastructure::cli::ui::colors::{RESET, YELLOW},
    prelude::Settings,
};
...
pub fn format_confirm_remove(id: i64) -> String {
    format_confirm(&Settings::t("ui.are_you_sure_remove").replace("{0}", &format!("{:03}", id)))
}
